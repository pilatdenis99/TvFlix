...
const Container = () => {
    ...
    return (
        <article className="container" page-content="">
            <Banner />
            <MovieList movieList={upcoming} title={"Upcoming Movies"}/>
            <MovieList movieList={trending} title={"Weekly Trending Movies"}/>
            <MovieList movieList={topRated} title={"Top Rated Movies"}/>
