            ...
            {movie &&
                <article className="container" page-content="">
                        ...
                        <div className="detail-box">
                            ...
                            <div className="slider-list">
                                <div className="slider-inner">
                                    {movie.videos?.results&&filterVideos(movie.videos.results).map((video) => <VideoCard name={video.name} videoKey={video.key}/>)}
                                </div>
                            </div>
                        </div>
                    </div>
                    <section className="movie-list" aria-label="You May Also Like">
                        ...
                        <div className="slider-list">
                            <div className="slider-inner">
                                {suggestions.results?.map((movie) => <MovieCard movie={movie}/>)}
                            </div>
                        </div>
                    </section>
                </article>
